...
enum class ColorApplication { BACKGROUND, BORDER, TEXT, ALL };
...
inline QString generateStyle(
    const QString& color, const ColorApplication application, const float opacity = 0.4, const int borderWidth = 1)
{
    QString style;
...
{
    static const std::map<QString, QString> colorValues = { { "Light0", Colors::Light0 }, { "Light1", Colors::Light1 },
        { "Light2", Colors::Light2 }, { "Light3", Colors::Light3 }, { "Dark0", Colors::Dark0 },
        { "Dark1", Colors::Dark1 }, { "Dark2", Colors::Dark2 }, { "Dark3", Colors::Dark3 }, { "Red", Colors::Red },
        { "Red Bright", Colors::RedBright }, { "Green", Colors::Green }, { "Green Bright", Colors::GreenBright },
        { "Yellow", Colors::Yellow }, { "Yellow Bright", Colors::YellowBright }, { "Blue", Colors::Blue },
        { "Blue Bright", Colors::BlueBright }, { "Purple", Colors::Purple }, { "Purple Bright", Colors::PurpleBright },
        { "Aqua", Colors::Aqua }, { "Aqua Bright", Colors::AquaBright }, { "Orange", Colors::Orange },
...
const static std::map<QString, QString> colorStyles = { { "Light0", getStyle("Light0", ColorApplication::BACKGROUND) },
