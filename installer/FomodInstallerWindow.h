...
class FomodInstallerWindow final : public QDialog {
  ...
  public:
    FomodInstallerWindow(FomodPlusInstaller* installer, GuessedValue<QString>& modName,
        const std::shared_ptr<IFileTree>& tree, QString fomodPath, const std::shared_ptr<FomodViewModel>& viewModel,
        const nlohmann::json& fomodJson, QWidget* parent = nullptr);
    ...
    [[nodiscard]] bool isManualInstall() const { return mIsManualInstall; }
